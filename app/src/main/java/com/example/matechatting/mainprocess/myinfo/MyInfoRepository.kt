...
class MyInfoRepository(
    ...
    companion object {
        ...
        fun getInstance(userInfoDao: UserInfoDao, loginDao: LoginDao, directionDao: DirectionDao) =
            instance ?: synchronized(this) {
                instance ?: MyInfoRepository(userInfoDao, loginDao, directionDao).also { instance = it }
            }
    }
}